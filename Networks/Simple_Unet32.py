...
#    inputs = Input(input_shape)
    ...
    conv1 = Conv2D(32, 3, activation='relu', padding='same', kernel_initializer='he_normal')(conv1_BN1)
    ...
    conv2 = Conv2D(64, 3, activation='relu', padding='same', kernel_initializer='he_normal')(conv2_BN1)
    ...
    conv3 = Conv2D(128, 3, activation='relu', padding='same', kernel_initializer='he_normal')(conv3_BN1)
    ...
    conv4 = Conv2D(256, 3, activation='relu', padding='same', kernel_initializer='he_normal')(conv4_BN1)
    ...
    conv5 = Conv2D(512, 3, activation='relu', padding='same', kernel_initializer='he_normal')(conv5_BN1)
    ...
    conv6 = Conv2D(256, 3, activation='relu', padding='same', kernel_initializer='he_normal')(conv6_BN1)
    conv6_BN2 = BatchNormalization(axis=1)(conv6, training=flag)

    up7 = Conv2D(128, 2, activation='relu', padding='same', kernel_initializer='he_normal')(UpSampling2D(size=(2, 2))(conv6_BN2))

    merge7 = concatenate([conv3_BN2, up7], axis=1)
    conv7 = Conv2D(128, 3, activation='relu', padding='same', kernel_initializer='he_normal')(merge7)
    conv7_BN1 = BatchNormalization(axis=1)(conv7, training=flag)
    conv7 = Conv2D(128, 3, activation='relu', padding='same', kernel_initializer='he_normal')(conv7_BN1)
    conv7_BN2 = BatchNormalization(axis=1)(conv7, training=flag)

    up8 = Conv2D(64, 2, activation='relu', padding='same', kernel_initializer='he_normal')(UpSampling2D(size=(2, 2))(conv7_BN2))
    merge8 = concatenate([conv2_BN2, up8], axis=1)
    conv8 = Conv2D(64, 3, activation='relu', padding='same', kernel_initializer='he_normal')(merge8)
    conv8_BN1 = BatchNormalization(axis=1)(conv8, training=flag)
    conv8 = Conv2D(64, 3, activation='relu', padding='same', kernel_initializer='he_normal')(conv8_BN1)
    conv8_BN2 = BatchNormalization(axis=1)(conv8, training=flag)

    up9 = Conv2D(32, 2, activation='relu', padding='same', kernel_initializer='he_normal')(UpSampling2D(size=(2, 2))(conv8_BN2))
    merge9 = concatenate([conv1, up9], axis=1)
    conv9 = Conv2D(32, 3, activation='relu', padding='same', kernel_initializer='he_normal')(merge9)
    conv9_BN1 = BatchNormalization(axis=1)(conv9, training=flag)
    conv9 = Conv2D(32, 3, activation='relu', padding='same', kernel_initializer='he_normal')(conv9_BN1)
