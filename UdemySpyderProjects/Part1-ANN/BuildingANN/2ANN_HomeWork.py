...
Credit Score: 600, 300
Gender: Male, Female
Age: 40 years old, 20
Tenure: 3 years, 1
Balance: $60000, $0
Number of Products: 2, 0
Does this customer have a credit card ? Yes, No
Is this customer an Active Member: Yes, No
Estimated Salary: $50000, $0"""
hw_data = np.array([[0.0, 0, 600, 1, 40, 3, 60000, 2, 1, 1, 50000],
                    [0.0, 0, 00, 0, 00, 0, 0, 0, 0, 0, 0]])
sc1 = StandardScaler()
#hw_data = sc1.fit_transform(hw_data)
new_prediction = classifier.predict(hw_data)
